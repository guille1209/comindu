            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.alimento.new_alimento') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => '/alimento', 'class' => 'cmxform form-horizontal', 'id' => 'nameForm')) !!}

                            @include('alimento.form', ['button' => trans('ui.alimento.button_add')])
