            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.plato.edit_plato') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::model($plato, ['method' => 'PUT', 'route' => ['plato.update', $plato->id], 'class' => 'cmxform form-horizontal', 'id' => 'nameForm']) !!}

                            @include('plato.form', array('plato' => $plato) + compact('plato', 'grupo_plato'), ['button' => trans('ui.plato.button_update')])
