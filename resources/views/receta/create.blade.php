            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.receta.new_receta') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => 'receta/store', 'class' => 'cmxform form-horizontal', 'id' => 'nameForm')) !!}

                            @include('receta.form', ['button' => trans('ui.receta.button_add')])
